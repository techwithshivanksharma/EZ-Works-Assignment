...
import MainImage from "../../assets/images/ArtCurationImg/Frame17.png";
import ExploreArrow from "../../assets/images/BrandingPageImages/Arrow.svg";
import Icon1 from "../../assets/images/ArtCurationImg/Icon1.svg";
import Icon2 from "../../assets/images/ArtCurationImg/Icon2.svg";
import Icon3 from "../../assets/images/ArtCurationImg/Icon3.svg";
import Icon4 from "../../assets/images/ArtCurationImg/Icon4.svg";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-10 md:gap-20 mt-8 w-full">
        ...
        <div className="max-w-md text-center md:text-left">
          <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-4">
            Art isn't meant to sit on distant walls- it's meant to breath, to
          ...
          <p className="text-[#252729] font-semibold mb-2">V curates:</p>
          <ul className="list-disc list-inside space-y-2 text-sm sm:text-base text-left">
            <li>Art Festival</li>
            <li>Live Performaces</li>
      ...
      <img
        src={Icon4}
        alt="Star Icon"
        className="absolute top-80  right-50 w-10 sm:w-12 md:w-14 opacity-80 md:block hidden"
      />
      {/* Top-right Icon */}
      <img
        src={Icon3}
